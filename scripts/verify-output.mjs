...
for(const [route,expected] of [['',['Kauan Borges','Software developer','Projects','Instant Payment System','Movie discovery']],['projects/pix',['The target I set','Measured in two separate runs','0.86','0.27','Check the measurements','265.195']]]){
 ...
 if(route==='projects/pix'){assert.ok(html.includes('app-payment-study'));assert.ok(!/app-payment-example|app-system-map|app-test-results|pix-story|pix-metrics/.test(html));}
