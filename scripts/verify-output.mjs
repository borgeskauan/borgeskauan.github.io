...
for(const [route,expected] of [['',['Kauan Borges','Software developer','Projects','Instant Payment System','Movie discovery']],['projects/pix',['Setting the target','Finding what needed to change','What the tests showed','2,100','99%','Test reports']]]){
