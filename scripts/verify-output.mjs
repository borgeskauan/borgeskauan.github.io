...
for(const [route,expected] of [['',['Kauan Borges','Software developer','Projects','Instant Payment System','Movie discovery']],['projects/pix',['I was responsible for its design, implementation and testing.','What the tests showed','Measurements and original reports','265.195','Code and engineering notes']]]){
 ...
 if(route==='projects/pix'){assert.ok(!html.includes('app-payment-example'));assert.ok(!html.includes('app-system-map'));}
