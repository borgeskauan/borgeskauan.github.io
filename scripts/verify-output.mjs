...
for(const [route,expected] of [['',['Kauan Borges','Software developer','Projects','Instant Payment System','Movie discovery']],['projects/pix',['The goal','Finding what needed to change','Both tests met the target','Target: at least 2,000','2,100','99%','Test reports']]]){
