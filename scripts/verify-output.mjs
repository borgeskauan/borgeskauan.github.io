...
for(const [route,expected] of [['',['Kauan Borges','Software developer','Projects','Instant Payment System','Movie discovery']],['projects/pix',['What I wanted to find out','A payment through the system','What needed to work reliably','What the tests showed','265.195','pix-journey']]]){
 ...
 if(route==='projects/pix'){assert.ok(!html.includes('app-payment-example'));}
